...
- 1. Predicting loan default risk
- 1. Forecasting stock prices
- 1. Forecasting global climate change
- 1. Detecting AI generated images/text/etc.
- 1. Projecting athletic performance
- 1. Predicting sports game outcomes
- 1. Clinical drug trials
- 1. Predicting hospital readmission risk
- 1. Allocating emergency response resources
- 1. Forecasting energy demand
- 1. Predicting wildfire risk
- 1. Predicting air quality
- 1. Recommending content (e.g. Netflix)
- 1. Detecting online bots
- 1. Predicting election results
- 1. Other (after office hours discussion)
...
*Source: converted from `project-1-rubric.pdf` for personal tracking.*